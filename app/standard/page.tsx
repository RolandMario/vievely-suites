        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="rounded-[3rem] overflow-hidden shadow-2xl h-[500px]">
              <img src={SUITES[0].images[0]} className="w-full h-full object-cover" alt={SUITES[0].name} />
            </div>
            <div className="grid grid-cols-2 gap-6">
              <div className="rounded-[2.5rem] overflow-hidden h-64 shadow-xl">
                <img src={SUITES[0].images[1]} className="w-full h-full object-cover" alt="Detail 1" />
              </div>
          ...
          <div className="lg:col-span-5 py-6">
            <div className="sticky top-32">
              <span className="text-amber-600 font-bold uppercase tracking-widest text-sm">{SUITES[0].tagline}</span>
              <h1 className="text-5xl font-black text-slate-900 mt-2 mb-6">{SUITES[0].name}</h1>
              <div className="flex items-baseline gap-2 mb-8">
                <span className="text-4xl font-black text-slate-900">N{SUITES[0].price}</span>
              ...
              <div className="grid grid-cols-2 gap-8 mb-10 border-y border-slate-100 py-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold">{SUITES[0].size}</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
